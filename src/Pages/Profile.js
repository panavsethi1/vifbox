                          ...
                          <div className="col-md-12">
                            ...
                            >
                              ...
                              <i
                                ...
                                onClick={() =>
                                  setpasswordCntrl1(!passwordCntrl1)
                                }
                                style={{
                                  fontSize: "15px",
                                }}
                          ...
                          <div className="col-md-12">
                            ...
                            >
                              ...
                              <i
                                ...
                                id="change_password_eyeslash1"
                                onClick={() =>
                                  setpasswordCntrl2(!passwordCntrl2)
                                }
                                style={{
                                  fontSize: "15px",
                                }}
                          ...
                          <div className="col-md-12">
                            ...
                            >
                              ...
                              <i
                                ...
                                id="change_password_eyeslash1"
                                onClick={() =>
                                  setpasswordCntrl3(!passwordCntrl3)
                                }
                                style={{
                                  fontSize: "15px",
                                }}
                  ...
                  <div className="card-body">
                    ...
                    <div className="row mt-5">
                      ...
                      <div className="col-10">
                        ...
                        <p
                          ...
                          style={{ cursor: "pointer", color: "#26237b" }}
                          onClick={() => {
                            axios
                    ...
                    <div className="row mt-5">
                      ...
                      <div className="col-10">
                        ...
                        <small>
                          Protect your Vifbox account with both your password &
                          a phone code.
                        </small>
                        <p
                          className="mt-2 font-weight-bold"
